    ...
    public class SeedData
    {
        ...
        private static void EnsureTrailsPopulated(ApplicationDbContext dbContext)
        {
            ...
            dbContext.Stages.AddRange(
                new Stage { StageName="Etapa Grande", StageStartLoc="Guarda", StageEndLoc="Floresta", IsActivated=true, Distance=5, Duration=60},
                new Stage { StageName = "Etapa Curta", StageStartLoc = "Seia", StageEndLoc = "Torre", IsActivated = false, Distance = 10, Duration = 120 }
                );
