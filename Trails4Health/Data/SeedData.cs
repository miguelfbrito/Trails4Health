...
namespace Trails4Health.Models
{
    public class SeedData
    {
        public static void EnsurePopulated(IServiceProvider appServices)
        {
            ...
            if (!dbContext.Tourist_Trails.Any()) { 
        ...
        private static void EnsureTrailsPopulated(ApplicationDbContext dbContext)
        {
            ...
            //  );
       //     dbContext.Tourist_Trails.AddRange(
       //   new Historic { TrailID = 1, TouristID = 1, Duration = 120, Observations = "No observations", RealizationDate = "21/10/2017" },
       //   new Historic { TrailID = 2, TouristID = 1, Duration = 75, Observations = "No observations", RealizationDate = "22/10/2017" },
       //   new Historic { TrailID = 3, TouristID = 1, Duration = 180, Observations = "No observations", RealizationDate = "23/10/2017" },
       //   new Historic { TrailID = 4, TouristID = 1, Duration = 200, Observations = "No observations", RealizationDate = "24/10/2017" }
       //);
